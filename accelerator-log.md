...
┃ ┃ ┃ Debug Adding symbol workloadResourceName with value 'baz-sink'
...
┃ ┃ ┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [<groupId>com.example</groupId>-><groupId>com.example...(truncated), streaming-app-template->baz-sink, <groupId>streaming-app-template</groupId>-><groupId>baz-sink</g...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"msgBrokerName":"stream-sample-message-broker","resultChannel":"foo-result","bsGitBranch":"main","artifactVersion":"0.0.1-beta","workloadResourceName":"baz-sink","resultChannelGroup":"foo-result-group","sourceChannel":"foo-source","bsGitRepository":"github.com?owner=tanzu-demo&repo=baz-sink","groupId":"com.example","bindingName":"foo","eventSinkRole":true,"eventSourceRole":false,"liveUpdateIDESupport":true,"includeBuildToolWrapper":true,"lambaObjectPlural":"foos","artifactId":"baz-sink","mainClassName":"StreamApplication","packageName":"com.example.tanzu.streamtemplate","packageDirectory":"com/example/tanzu/streamtemplate","objectModelClassName":"Foo","projectName":"baz-sink","eventProcessRole":false,"lambaObjectSingleton":"foo","sourceChannelGroup":"foo-source-group"}
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input15457763613645355789, --data-values-file, /tmp/accelerator-options9076597443578843493.json, --output-files, /tmp/ytt-output4044714312522847179]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Condition (#eventSinkRole) evaluated to true
┃ ┃ ┃ ┃ ┃ ┃ ┃  Info Combo running as Chain
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [com.example.tanzu.streamtemplate->com.example.tanzu.st...(truncated)]
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[1].delegate.transformations[0].sources[4].delegate.transformations[2] (ReplaceText)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [Foo->Foo]
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[1].delegate.transformations[0].sources[4].delegate.transformations[3] (ReplaceText)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [foos->foos]
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[1].delegate.transformations[0].sources[4].delegate.transformations[4] (ReplaceText)
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [foo->foo]
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].validated.delegate.in.transformations[1].delegate.transformations[0].sources[4].delegate.transformations[5] (RewritePath)
┃ ┃ ┃ ┃ ┃ ┗ ┗ ┗ Debug Path 'src/main/java/com/example/tanzu/streamtemplate/functions/FooSink.java' matched 'src/(?<sourceset>.*)/java/(?<currentpackage>.*/)streamtemplate/functions/FooSink.java' with groups {sourceset=main, currentpackage=com/example/tanzu/, g0=src/main/java/com/example/tanzu/streamtemplate/functions/FooSink.java, g1=main, g2=com/example/tanzu/} and was rewritten to 'src/main/java/com/example/tanzu/streamtemplate/functions/FooSink.java'
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/example/tanzu/streamtemplate/functions/FooSink.java didn't match [config/workload.yaml] -> included
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/example/tanzu/streamtemplate/functions/FooSink.java didn't match [config/workload.yaml] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Wrote values file with json content:   {"msgBrokerName":"stream-sample-message-broker","resultChannel":"foo-result","bsGitBranch":"main","artifactVersion":"0.0.1-beta","workloadResourceName":"baz-sink","resultChannelGroup":"foo-result-group","sourceChannel":"foo-source","bsGitRepository":"github.com?owner=tanzu-demo&repo=baz-sink","groupId":"com.example","bindingName":"foo","eventSinkRole":true,"eventSourceRole":false,"liveUpdateIDESupport":true,"includeBuildToolWrapper":true,"lambaObjectPlural":"foos","artifactId":"baz-sink","mainClassName":"StreamApplication","packageName":"com.example.tanzu.streamtemplate","packageDirectory":"com/example/tanzu/streamtemplate","objectModelClassName":"Foo","projectName":"baz-sink","eventProcessRole":false,"lambaObjectSingleton":"foo","sourceChannelGroup":"foo-source-group"}
┃ ┃ ┃ ┃ ┃ ┗ ┗ ┗  Info Shelling out to YTT with args: [ytt, -f, /tmp/ytt-input13790274023276827847, --data-values-file, /tmp/accelerator-options13903259266656860555.json, --output-files, /tmp/ytt-output9149156009985721248]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/example/tanzu/streamtemplate/functions/FooSink.java didn't match [Tiltfile] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┗ ┗  Info Will replace [my-project->baz-sink]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/example/tanzu/streamtemplate/functions/FooSink.java didn't match [DEPLOYING.md] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=tanzu-demo&repo=baz-sink'
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug src/main/java/com/example/tanzu/streamtemplate/functions/FooSink.java didn't match [mvnw, mvnw.cmd, .mvn/**] -> excluded
...
┃ ┃ ┃ ┃ ┃ ┃ Debug Multiple representations for path 'src/main/java/com/example/tanzu/streamtemplate/functions/FooSink.java', will use the one appearing first 
